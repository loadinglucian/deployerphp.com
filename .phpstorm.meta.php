...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/lucian/Developer/deployer-docs/public/storage' => 'string',
...
'debugbar.debug_backtrace_limit','docs.path','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/lucian/Developer/deployer-docs/public/storage',
...
'session.partitioned','boost.enabled','boost.browser_logs_watcher','mcp.redirect_domains','structure-discoverer.ignored_files',
...
'debugbar.queries.explain','boost.browser-logs','storage.local',);
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','DOCS_PATH',);
